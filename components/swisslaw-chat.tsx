...
export default function SwisslawChat() {
  ...
  async function research(event: FormEvent) {
    ...
    try {
      ...
      setMessages(previous => [...previous, { role: 'assistant', text: resultText, answer: result, sources }]);
      ...
      setPhase('idle'); setQuery(''); input.current?.focus();
